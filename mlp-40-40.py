...
with tf.Session() as sess:
    ckpt = tf.train.get_checkpoint_state('checkpoints-40-40/')
    if ckpt and ckpt.model_checkpoint_path:
        ...
        if not os.path.exists('checkpoints-40-40'):
            os.makedirs('checkpoints-40-40')
    ...
    for epoch in range(epoch_n + 1, training_epochs):
        ...
        if epoch % checkpoint_step == 0:
            ...
            saver.save(sess, 'checkpoints-40-40/model.ckpt', epoch)
